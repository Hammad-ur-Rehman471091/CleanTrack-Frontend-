...
// TODO (refactor): extract nav items config to a separate navConfig.js
// TODO (refactor): convert inline styles to proper Tailwind component classes
...
function Navbar({ currentPage, setCurrentPage }) {
  ...
  // TODO (refactor): move this config out to a constants file
  const IconDashboard = () => (
  ...
  const navItems = {
    manager: [
      ...
      { id: 'issues', label: 'All Issues', Icon: IconBug },
    ],
    tester: [
      { id: 'dashboard', label: 'Dashboard', Icon: IconDashboard },
      { id: 'report', label: 'Report Bug', Icon: IconPlus },
      { id: 'issues', label: 'My Reports', Icon: IconClipboard },
    ],
    developer: [
      { id: 'dashboard', label: 'Dashboard', Icon: IconDashboard },
      { id: 'issues', label: 'Assigned Issues', Icon: IconWrench },
    ],
  };
